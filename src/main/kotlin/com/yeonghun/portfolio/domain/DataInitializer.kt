package com.yeonghun.portfolio.domain
...
/**
 *packageName    : com.yeonghun.portfolio.domain
...
class DataInitializer (
    ...
    @PostConstruct
    fun init(){
        logger.info { "Initializing DataInitializer..." }

        val achievements = mutableListOf<Achievement>(
            Achievement(
                title = "2022 Catkao 해커톤 최우수상",
                description = "고양이 쇼핑몰 검색 서비스의 아키텍쳐, 데이터 모델링, API 개발 역할 수행",
        ...
        val introductions = mutableListOf<Introduction>(
            Introduction(
                content = "주도적으로 문제를찾고, 해결하는 고양이입니다.",
                isActive = true
            ),
            Introduction(
        ...
        val links = mutableListOf<Link>(
            Link(name = "Github", content = "https://github.com/Yeong-Huns", isActive = true),
            Link(name = "velog", content = "https://velog.io/@vosxja1/posts", isActive = true),
        )
        ...
        experience1.addDetails(
            mutableListOf(
                ...
                ExperienceDetail(content = "소프트웨어 연구 학회 할동", isActive = true),
            )
        )
        ...
        val java = Skill(name = "Java", type = SkillType.LANGUAGE, isActive = true)
        val kotlin = Skill(name = "Kotlin", type = SkillType.LANGUAGE, isActive = true)
        val python = Skill(name = "Python", type = SkillType.LANGUAGE, isActive = true)
        val spring = Skill(name = "Spring", type = SkillType.FRAMEWORK, isActive = true)
        val django = Skill(name = "Django", type = SkillType.FRAMEWORK, isActive = true)
        val mysql = Skill(name = "MySQL", type = SkillType.DATABASE, isActive = true)
        val redis = Skill(name = "Redis", type = SkillType.DATABASE, isActive = true)
        val kafka = Skill(name = "Kafka", type = SkillType.TOOL, isActive = true)
        skillRepository.saveAll(mutableListOf(java, kotlin, python, spring, django, mysql, redis, kafka))

        val project1 = Project(
            name = "유기묘 발견 정보 공유 서비스",
            description = "유기묘 위치의 실시간 공유, 임시보호까지 연결해주는 서비스. 구글 맵스를 연동하여 유기묘 위치 정보를",
            startYear = 2022,
            startMonth = 9,
            endYear = 2022,
            endMonth = 12,
        ...
        project1.addDetails(
            mutableListOf(
                ProjectDetail(content = "구글 맵스를 활용한 유기묘 발견 지역 정보 제공 API 개발", isActive = true, url = null),
                ProjectDetail(content = "Redis 적용하여 인기 게시글의 조회 속도 1.5초 -> 0.5초로 개선", isActive = true, url = null)
            )
        )
        ...
        project2.addDetails(
            mutableListOf(
                ProjectDetail(content = "PIL(Pillow) 활용하여 이미지 분석 기능 개발", isActive = true, url = null),
                ProjectDetail(content = "알림 발송을 비동기 처리하여 이미지 분석 - 알림 발송 기능간 의존도 감소", isActive = true, url = null),
                ProjectDetail(content = "Github Repository", isActive = true, url = "https://github.com/Yeong-Huns"),
            )
        )
